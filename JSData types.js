...
let p1 = new Clothes(12, `pants`, `prosto pents`, 120, 22, [`img1`, `img2`],
   1999, 04, 12, 16, 34, 56, `nike`, `cotton`, `black`, `S,L,M`, `M`);
let p2 = new Clothes(22, `t-shirt`, `prosto t-shirt`, 130, 12, [`img1`, `img2`],
   1999, 04, 12, 16, 34, 56, `adidas`, `cotton`, `black`, `S,L,M`, `L`);
let p3 = new Clothes(32, `hat`, `prosto hat`, 140, 52, [`img1`, `img2`],
   1999, 04, 12, 16, 34, 56, `kenzo`, `cotton`, `black`, `S,L,M`, `S`);

let products = [p1, p2, p3];

let p4 = new Clothes(12, `frige`, `prosto frige`, 1200, 2, [`img1`, `img2`],
   1999, 04, 12, 16, 34, 56, `snaige`, `3 years`, `300W`);
let p5 = new Clothes(22, `teapot`, `prosto teapot`, 230, 42, [`img1`, `img2`],
   1999, 04, 12, 16, 34, 56, `samsung`, `2 years`, `1KW`);
let p6 = new Clothes(32, `TV`, `prosto TV`, 1400, 10, [`img1`, `img2`],
   1999, 04, 12, 16, 34, 56, `ERGO`, `4 years`, `250W`);

   let productsElectronics = [p4,p5,p6];